...
wget -q -O "$SERVICE_FILE" 'https://raw.githubusercontent.com/OpsMx/server_monitor/master/monitoragent.sh'
...
wget -q -O "$SYSTEM_CHECK" 'https://raw.githubusercontent.com/OpsMx/server_monitor/master/SystemCheck.py'
chmod +x "$SYSTEM_CHECK"
wget -q -O "$NETWORK_CHECK" 'https://raw.githubusercontent.com/OpsMx/server_monitor/master/NetworkCheck.py'
